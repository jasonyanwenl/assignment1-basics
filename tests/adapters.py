...
from cs336_basics import adamw, functions
...
def run_get_batch(
    ...
    """
    return functions.data_loading(dataset, batch_size, context_length, device)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return functions.learning_rate_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
